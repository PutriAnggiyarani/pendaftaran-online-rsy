<x-guest-layout>
    ...
    <div class="bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.06)] p-8">
        <div class="text-center mb-6">
            ...
            <p class="text-[#64748b] text-sm mt-1">Gunakan Email yang terdaftar untuk masuk</p>
        </div>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="mb-4">
                <label for="email" class="block text-sm font-semibold text-[#334155] mb-2">Username</label>
                <div class="relative">
                    ...
                    <input id="email"
                        class="block w-full pl-10 pr-3 py-2.5 border border-gray-200 rounded-xl text-sm shadow-sm focus:ring-[#4ebde1] focus:border-[#4ebde1]"
                        type="email" name="email" value="pasien@dummy.com" placeholder="Masukkan NIK atau No RM"
            ...
            <div class="mb-6">
                ...
                <div class="relative">
                    ...
                    <input id="password"
                        class="block w-full pl-10 pr-3 py-2.5 border border-gray-200 rounded-xl text-sm shadow-sm focus:ring-[#4ebde1] focus:border-[#4ebde1]"
                        type="password" name="password" value="password123" placeholder="Masukkan password" required
        ...
        <div class="flex flex-col gap-3">
            <a href="{{ route('register') }}"
                class="w-full flex justify-center py-2.5 px-4 border border-transparent rounded-xl shadow-sm text-sm font-bold text-white bg-[#81c784] hover:bg-[#6ab36d] transition-colors">
                Daftar Akun
            </a>
        </div>
    </div>
